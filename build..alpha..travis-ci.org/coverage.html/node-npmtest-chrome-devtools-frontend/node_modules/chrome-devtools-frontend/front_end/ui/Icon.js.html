...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-chrome-devtools-frontend/node_modules/chrome-devtools-frontend/front_end/ui/Icon.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-chrome-devtools-frontend/node_modules/chrome-devtools-frontend/front_end/ui/Icon.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-chrome-devtools-frontend/node_modules/chrome-devtools-frontend/front_end/ui/</a> &#187; Icon.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    throw new Error('icon must be created via factory method.');</span>
  }
&nbsp;
  /**
   ...
   * @return {!UI.Icon}
   */
  static create<span class="fstat-no" title="function not covered" >(iconType, className) {</span>
<span class="cstat-no" title="statement not covered" >    if (!UI.Icon._constructor)</span>
<span class="cstat-no" title="statement not covered" >      UI.Icon._constructor = UI.registerCustomElement('span', 'ui-icon', UI.Icon.prototype);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var icon = /** @type {!UI.Icon} */ (new UI.Icon._constructor());</span>
<span class="cstat-no" title="statement not covered" >    if (className)</span>
<span class="cstat-no" title="statement not covered" >      icon.className = className;</span>
<span class="cstat-no" title="statement not covered" >    if (iconType)</span>
<span class="cstat-no" title="statement not covered" >      icon.setIconType(iconType);</span>
...
<span class="cstat-no" title="statement not covered" >    this._descriptor = null;</span>
    /** @type {?UI.Icon.SpriteSheet} */
<span class="cstat-no" title="statement not covered" >    this._spriteSheet = null;</span>
    /** @type {string} */
<span class="cstat-no" title="statement not covered" >    this._iconType = '';</span>
  }
&nbsp;
  /**
   * @param {string} iconType
   */
  setIconType<span class="fstat-no" title="function not covered" >(iconType) {</span>
<span class="cstat-no" title="statement not covered" >    if (this._descriptor) {</span>
<span class="cstat-no" title="statement not covered" >      this.style.removeProperty('--spritesheet-position');</span>
<span class="cstat-no" title="statement not covered" >      this.style.removeProperty('width');</span>
<span class="cstat-no" title="statement not covered" >      this.style.removeProperty('height');</span>
<span class="cstat-no" title="statement not covered" >      this._toggleClasses(false);</span>
<span class="cstat-no" title="statement not covered" >      this._iconType = '';</span>
<span class="cstat-no" title="statement not covered" >      this._descriptor = null;</span>
<span class="cstat-no" title="statement not covered" >      this._spriteSheet = null;</span>
    }
<span class="cstat-no" title="statement not covered" >    var descriptor = UI.Icon.Descriptors[iconType] || null;</span>
<span class="cstat-no" title="statement not covered" >    if (descriptor) {</span>
<span class="cstat-no" title="statement not covered" >      this._iconType = iconType;</span>
<span class="cstat-no" title="statement not covered" >      this._descriptor = descriptor;</span>
<span class="cstat-no" title="statement not covered" >      this._spriteSheet = UI.Icon.SpriteSheets[this._descriptor.spritesheet];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.style.setProperty('--spritesheet-position', this._propertyValue());</span>
<span class="cstat-no" title="statement not covered" >      this.style.setProperty('width', this._spriteSheet.cellWidth + 'px');</span>
<span class="cstat-no" title="statement not covered" >      this.style.setProperty('height', this._spriteSheet.cellHeight + 'px');</span>
<span class="cstat-no" title="statement not covered" >      this._toggleClasses(true);</span>
    } else <span class="cstat-no" title="statement not covered" >if (iconType) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(`ERROR: failed to find icon descriptor for type: ${iconType}`);</span>
    }
  }
&nbsp;
  /**
   * @param {boolean} value
   */
  _toggleClasses<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >    this.classList.toggle('spritesheet-' + this._descriptor.spritesheet, value);</span>
<span class="cstat-no" title="statement not covered" >    this.classList.toggle(this._iconType, value);</span>
<span class="cstat-no" title="statement not covered" >    this.classList.toggle('icon-mask', value &amp;&amp; !!this._descriptor.isMask);</span>
  }
&nbsp;
  /**
   * @return {string}
   */
  _propertyValue<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this._descriptor.coordinates) {</span>
<span class="cstat-no" title="statement not covered" >      if (!this._descriptor.position || !UI.Icon._positionRegex.test(this._descriptor.position))</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(`ERROR: icon '${this._iconType}' has malformed position: '${this._descriptor.position}'`);</span>
<span class="cstat-no" title="statement not covered" >      var column = this._descriptor.position[0].toLowerCase().charCodeAt(0) - 97;</span>
<span class="cstat-no" title="statement not covered" >      var row = parseInt(this._descriptor.position.substring(1), 10) - 1;</span>
<span class="cstat-no" title="statement not covered" >      this._descriptor.coordinates = {</span>
...
<span class="cstat-no" title="statement not covered" >    return `${this._descriptor.coordinates.x}px ${this._descriptor.coordinates.y}px`;</span>
  }
};
&nbsp;
<span class="cstat-no" title="statement not covered" >UI.Icon._positionRegex = /^[a-z][1-9][0-9]*$/;</span>
&nbsp;
/** @typedef {{position: string, spritesheet: string, isMask: (boolean|undefined)}} */
<span class="cstat-no" title="statement not covered" >UI.Icon.Descriptor;</span>
&nbsp;
/** @typedef {{cellWidth: number, cellHeight: number, padding: number}} */
<span class="cstat-no" title="statement not covered" >UI.Icon.SpriteSheet;</span>
&nbsp;
/** @enum {!UI.Icon.SpriteSheet} */
<span class="cstat-no" title="statement not covered" >UI.Icon.SpriteSheets = {</span>
...
<span class="cstat-no" title="statement not covered" >UI.Icon.Descriptors = {</span>
